...
const Nav = () => {
  return (
    <Navbar className='border border-b-gray-200 border-b-2 p-2' fluid rounded>
      <Navbar.Collapse>
        <div className='sm:hidden lg:block pl-10 pt-1'>
          <FaBars size={18} className=' font-thin pb-0'/>
        </div>
        {/* Conditionally render Shop and Home links */}
        <Navbar.Link href="#" active className='text-base hidden sm:block'>Home</Navbar.Link>
        <Navbar.Link href="#" className='text-base hidden sm:block'>Shop</Navbar.Link>
      </Navbar.Collapse>
